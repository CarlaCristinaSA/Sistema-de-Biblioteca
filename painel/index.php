...
if ($linhas > 0) {
    ...
    $categoria_usuario = $resultado[0]['categoria'];
    $telefone_usuario = $resultado[0]['telefone'];
    $cpf_sistema = $resultado[0]['CPF'];
...
<html>
<head>
	<title>Biblioteca Professor Nicásio</title>
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-book open"></span> Biblioteca<span class="dashboard_text">Professor Nicácio </span></a></h1>
					</div>
						...
						<ul class="sidebar-menu">
							...
							<li class="treeview">
								...
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i>Funcionários</a></li>
									
								</ul>
								<ul class="treeview-menu">
									<li><a href="index.php?pagina=usuarios"><i class="fa fa-angle-right"></i>Leitores</a></li>
							...
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
								<div class="profile_img">	
									...
									<div class="user-name esc">
										...
										<span><?php echo $categoria_usuario?></span>
									</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-6">							
								<label>CPF</label>
								<input type="text" class="form-control" id="cpf_sistema" name="cpf" placeholder="Seu CPF" value="<?php echo $cpf_sistema ?>">							
						</div>
					...
					<div class="row">
						<div class="col-md-12">							
								...
								<input type="text" class="form-control" id="endereco_perfil" name="endereco" placeholder="Seu Endereço" value="<?php echo $endereco_usuario ?>" required>							
						</div>
					...
					<div class="row">
						...
						<div class="col-md-4">								
							<img src="images/perfil/<?php echo $foto_usuario ?>"  width="90px" id="target-usu">								
		...
		<div class="modal-content">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								<label>CPF</label>
								<input type="varchar" class="form-control" id="cpf_sistema" name="cpf_sistema" placeholder="Seu CPF" value="<?php echo @$cpf_sistema ?>">							
						</div>
